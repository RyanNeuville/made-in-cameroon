<?php $page_title = "Mon Profil"; require_once '../includes/head.php'; ?>
<?php require_once '../includes/navbar_client.php'; ?>

<main class="container mx-auto px-4 py-8 max-w-2xl">
    <h1 class="text-3xl font-bold mb-6 text-gray-800"><i class="fa fa-cog" aria-hidden="true"></i> Mon Profil et Paramètres</h1>
    ...
    <div class="card bg-white shadow-xl p-6">
        <form action="traitement_profil.php" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" value="ryan.feussi@example.com" class="input input-bordered w-full bg-gray-100" readonly />
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="adresse" class="textarea textarea-bordered w-full">Rue de la Paix, Douala, Littoral</textarea>
            </div>
