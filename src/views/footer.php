<footer class="mt-20 footer sm:footer-horizontal bg-success text-base-content p-10 text-white text-md">
    <aside>
        ...
        <p>
            <span>
                Plus qu'une plateforme, c'est le carrefour numérique des saveurs et des talents locaux.
                bâtisons l'avenir du Cameroun, un clic à la fois.
            </span>
            <br />
            Produits locaux depuis <?php echo date("Y"); ?>
        </p>
        <div class="join">
            <div>
                <label class="input validator join-item text-black">
            ...
            <button class="btn btn-warning join-item">M'abonner</button>
        </div>
    </aside>
    <nav>
